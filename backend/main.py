...
import io
from industries import INDUSTRY_NEEDS
...
async def analyze_waste(file: UploadFile = File(...)):
    ...
    {{
      ...
      "reuse_suggestions": [
        "specific industry or product this waste could be reused for/as",
      ...
      "matched_industries": ["list of 2-4 industry names from this list that could realistically reuse this exact waste, based on the materials they need: {[i['industry'] for i in INDUSTRY_NEEDS]}. Only include industries whose materials_needed list plausibly matches the waste type you identified. Reference data: {INDUSTRY_NEEDS}"]
    }}
